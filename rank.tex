...
\begin{itemize}
	\item 个人用户之间的有效转账交易共有$2,567,832$条，参与交易的地址有$712,354$个，每次交易的平均金额为$\Xi 196.81$，每次交易的金额分布如\reffig{fig:txad}所示，大多数交易的金额都在$\Xi 100$以下。每对地址的交易次数分布如\reffig{fig:txnd}所示，有$91\%$的双方只进行了一或两次交易，因此$K$取$2$是合适的。
