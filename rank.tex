...
\begin{figure}[h]
	\centering
	\subfigure[X=$5000$, Y对排名的影响]{\includegraphics[width=0.48\textwidth]{figs/deposit.pdf}}
	\subfigure[Y=$\Xi5000$, X对排名的影响]{ \includegraphics[width=0.48\textwidth]{figs/times.pdf} }
