...
我们收集了以太坊上从2017年5月份交易数据，计算了第一周的DIP排名，如表1所示。
...
伪造账户然后伪造合约调用将不太可行，假设作弊者想要提高合约C的排名，并为此伪造了大量账户，但由于在公式\ref{formula:dip:scs}中计算SCS时，只有NR排名中Top X的调用贡献分大于0，所以伪造低NR的账户将无法完成作弊，而要伪造高NR的账户在\refsec{subsec:leaderrank}已有分析。
