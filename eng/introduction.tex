...
It should be noted that the blockchain technology itself is not a brand new technological innovation, but a model innovation that combines a series of technologies including peer-to-peer communication, cryptography, blockchain data structure, etc.
