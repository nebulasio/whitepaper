...
the LLVM JIT, as shown in \reffig{fig:llvm}. \\
...
We construct the NVM based on LLVM, which is shown in \reffig{fig:nvm}. First
...
be executed, which is shown in \reffig{fig:nvm-process}.
