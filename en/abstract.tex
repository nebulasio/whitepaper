...
Bitcoin and Ethereum have successfully introduced ``Peer-to-Peer Electronic Cash System" and ``Smart Contract" to blockchain. The industry is evolving rapidly, with emerging application scenarios and business requirements. For current blockchain technologies, we find there are three challenges: measure of value, self-evolution capability, and healthy ecosystem development.
